...
cat >/root/oracle_gpu_generic_test.b64 <<'GEM5_EOF'
{guest_bin_b64}
GEM5_EOF
base64 -d /root/oracle_gpu_generic_test.b64 >/root/oracle_gpu_generic_test
chmod +x /root/oracle_gpu_generic_test
/root/oracle_gpu_generic_test
/sbin/m5 exit
exec /bin/sh
"""
...
print("Booting x86 FS system with generic OracleGPU test")
m5.stats.reset()
simulator.run()
